...
SECRET_KEY = 'django-insecure-7*m60h#xo6d8v!fid0e^j9v&cxhztwvsri8oj4os+%lnp3&rbd'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.BasicAuthentication',    # Basic authentication for API clients
    ),
